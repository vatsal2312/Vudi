...
contract BEP20Token is BEP20("Vudi", "Vudi", 18) {
    ...
    */
    ...
    address public_sale_wallet = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
    uint8 public_sale_percent = 54;
    ...
    constructor() {
        ...
        *--------------------------------------------
        */
        presales[0] = Presale(2, 20, false, 0, 0, 0xCCF86383BCAc8444f265e1F06905aE49cBB8bE2B, 10000000);
        presales[1] = Presale(2, 20, false, 0, 0, 0xCCF86383BCAc8444f265e1F06905aE49cBB8bE2B, 10000000);
        presales[2] = Presale(2, 20, false, 0, 0, 0xCCF86383BCAc8444f265e1F06905aE49cBB8bE2B, 10000000);
        ...
        *--------------------------------------------
        */
        team_locked.locked_percent = 10;
        address[1] memory team_locked_members;
        team_locked_members[0] = 0xCCF86383BCAc8444f265e1F06905aE49cBB8bE2B;
        team_locked.members= team_locked_members;
        team_locked.locked_timestamp = block.timestamp + 31536000;
        
        ecosystem_locked.locked_percent = 10;
        address[1] memory ecosystem_locked_members;
        ecosystem_locked_members[0] = 0xCCF86383BCAc8444f265e1F06905aE49cBB8bE2B;
        ...
        ai_locked_members_one[0] = 0xCCF86383BCAc8444f265e1F06905aE49cBB8bE2B;
        ai_locked[0].members = ai_locked_members_one;
        ai_locked[0].locked_timestamp = block.timestamp + 31536000;
        
        ai_locked[1].locked_percent = 5;
        address[1] memory ai_locked_members_two;
        ai_locked_members_two[0] = 0xCCF86383BCAc8444f265e1F06905aE49cBB8bE2B ;
        ai_locked[1].members = ai_locked_members_two;
        ai_locked[1].locked_timestamp = block.timestamp + 47304060;
        
        ai_locked[2].locked_percent = 10;
        address[1] memory ai_locked_members_three;
        ai_locked_members_three[0] = 0xCCF86383BCAc8444f265e1F06905aE49cBB8bE2B;
        ai_locked[2].members = ai_locked_members_three; 
        ai_locked[2].locked_timestamp = block.timestamp + 63072000;
        ...
        */
            ...
            // public sale minting.
            uint256 total_public_sale_mint = (_supply*public_sale_percent)/100;
            _mint(public_sale_wallet, total_public_sale_mint);
